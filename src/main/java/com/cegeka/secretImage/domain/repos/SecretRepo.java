...
public class SecretRepo {
    ...
    public SecretRepo() {
        this.secretPictures = Collections.synchronizedMap(new HashMap<Integer, SecretPicture>());
    }
    ...
    public SecretPicture getRandomSecretPicture() throws UnsupportedOperationException {
        ...
        return Collections.synchronizedList(new ArrayList<>(secretPictures.values())).get(item);
    }
